    ...
    <section id="listContainer">
        <div class="listContainerHeader">
            ...
            <PopoverHover id="addListFlyout">
                <template v-slot:target><span><a class="lpAdd" @click="newList"><i class="lpSprite lpSpriteAdd" />Add new list</a></span></template>
...
export default {
    ...
    methods: {
        ...
        removeList(list) {
            ...
            bus.emit('initSpeedbump', { callback, options: speedbumpOptions });
        },
    },
};
</script>
